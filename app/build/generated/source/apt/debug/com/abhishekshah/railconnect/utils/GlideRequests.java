package com.abhishekshah.railconnect.utils;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.abhishekshah.railconnect.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.abhishekshah.railconnect.utils.GlideOptions().apply(toSet));
    }
  }
}
